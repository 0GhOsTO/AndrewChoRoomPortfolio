...
renderer.outputColorSpace = THREE.SRGBColorSpace; // Already good

const composer = new EffectComposer(renderer);
composer.outputColorSpace = THREE.SRGBColorSpace; // << ADD THIS

const ssaaPass = new SSAARenderPass(scene, camera);
ssaaPass.sampleLevel = 4; // 0 to 5; try 4 or 5 for quality
ssaaPass.unbiased = true;
composer.addPass(ssaaPass);

//Convert the ColorCode
const outputPass = new OutputPass();
outputPass.colorSpace = THREE.SRGBColorSpace;
